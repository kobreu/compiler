...
public class TestLexer {
	...
	public void setUp() {
		...
		files.add(file);
		symbolsForCase = new Integer[] { sym.ID, sym.ASM, sym.ID, sym.LPAREN, sym.NUMBER, sym.COM, sym.NUMBER,
				sym.RPAREN };
		symbols.put(file, Arrays.asList(symbolsForCase));
		...
		files.add(file);
		symbolsForCase = new Integer[] { sym.ID, sym.ASM, sym.ID, sym.LPAREN, sym.LCURL, sym.NUMBER, sym.COM,
				sym.NUMBER, sym.RCURL, sym.RPAREN };
		symbols.put(file, Arrays.asList(symbolsForCase));
		...
		files.add(file);
		symbolsForCase = new Integer[] { sym.ID, sym.ASM, sym.NUMBER, sym.ID, sym.ASM, sym.NUMBER, sym.RETURN, sym.ID,
				sym.COM, sym.ID, sym.RETURN, sym.ID, sym.COM, sym.ID };
		symbols.put(file, Arrays.asList(symbolsForCase));

		file = "testinput/grammar/chunk_sequence_with_semicolons.lua";
		files.add(file);
		symbolsForCase = new Integer[] { sym.ID, sym.ASM, sym.NUMBER, sym.SEMI, sym.ID, sym.ASM, sym.NUMBER, sym.SEMI,
				sym.ID, sym.ASM, sym.NUMBER, sym.SEMI };
		symbols.put(file, Arrays.asList(symbolsForCase));

		file = "testinput/grammar/chunk_sequence_without_semicolons.lua";
		files.add(file);
		symbolsForCase = new Integer[] { sym.ID, sym.ASM, sym.NUMBER, sym.ID, sym.ASM, sym.NUMBER, sym.ID, sym.ASM,
				sym.NUMBER };
		symbols.put(file, Arrays.asList(symbolsForCase));
		...
		files.add(file);
		symbolsForCase = new Integer[] { sym.ID, sym.ASM, sym.LCURL, sym.NUMBER, sym.COM, sym.NUMBER, sym.COM,
				sym.NUMBER, sym.RCURL };
		symbols.put(file, Arrays.asList(symbolsForCase));
		...
		files.add(file);
		symbolsForCase = new Integer[] { sym.FOR, sym.ID, sym.IN, sym.NUMBER, sym.COM, sym.NUMBER, sym.COM, sym.NUMBER,
				sym.DO, sym.END };
		symbols.put(file, Arrays.asList(symbolsForCase));

		file = "testinput/grammar/field_exp.lua";
		files.add(file);
		symbolsForCase = new Integer[] { sym.ID, sym.ASM, sym.LCURL, sym.LBRACK, sym.NUMBER, sym.RBRACK, sym.ASM,
				sym.NUMBER, sym.RCURL };
		symbols.put(file, Arrays.asList(symbolsForCase));
		...
		files.add(file);
		symbolsForCase = new Integer[] { sym.ID, sym.ASM, sym.LCURL, sym.NUMBER, sym.SEMI, sym.NUMBER, sym.SEMI,
				sym.NUMBER, sym.COM, sym.NUMBER, sym.COM, sym.RCURL };
		symbols.put(file, Arrays.asList(symbolsForCase));

		file = "testinput/grammar/funcname_add_to_table.lua";
		files.add(file);
		symbolsForCase = new Integer[] { sym.FUNC, sym.ID, sym.DOT, sym.ID, sym.DOT, sym.ID, sym.LPAREN, sym.RPAREN,
				sym.END };
		symbols.put(file, Arrays.asList(symbolsForCase));

		file = "testinput/grammar/funcname_colon.lua";
		files.add(file);
		symbolsForCase = new Integer[] { sym.FUNC, sym.ID, sym.DOT, sym.ID, sym.DDOT, sym.ID, sym.LPAREN, sym.RPAREN,
				sym.END };
		symbols.put(file, Arrays.asList(symbolsForCase));
		...
		files.add(file);
		symbolsForCase = new Integer[] { sym.ID, sym.LPAREN, sym.NUMBER, sym.RPAREN, sym.DDOT, sym.ID, sym.LPAREN,
				sym.NUMBER, sym.RPAREN, sym.LPAREN, sym.NUMBER, sym.RPAREN };
		symbols.put(file, Arrays.asList(symbolsForCase));
		...
		files.add(file);
		symbolsForCase = new Integer[] { sym.FOR, sym.ID, sym.COM, sym.ID, sym.COM, sym.ID, sym.IN, sym.NUMBER, sym.DO,
				sym.END };
		symbols.put(file, Arrays.asList(symbolsForCase));
		...
		files.add(file);
		symbolsForCase = new Integer[] { sym.ID, sym.ASM, sym.ID, sym.LPAREN, sym.RPAREN, sym.LBRACK, sym.NUMBER,
				sym.RBRACK };
		symbols.put(file, Arrays.asList(symbolsForCase));
		...
		files.add(file);
		symbolsForCase = new Integer[] { sym.FOR, sym.ID, sym.ASM, sym.NUMBER, sym.COM, sym.NUMBER, sym.DO, sym.ID,
				sym.ASM, sym.NUMBER, sym.END };
		symbols.put(file, Arrays.asList(symbolsForCase));

		file = "testinput/grammar/stat_for.lua";
		files.add(file);
		symbolsForCase = new Integer[] { sym.FOR, sym.ID, sym.ASM, sym.NUMBER, sym.COM, sym.NUMBER, sym.COM,
				sym.NUMBER, sym.DO, sym.ID, sym.ASM, sym.NUMBER, sym.END };
		symbols.put(file, Arrays.asList(symbolsForCase));

		file = "testinput/grammar/stat_foreach.lua";
		files.add(file);
		symbolsForCase = new Integer[] { sym.FOR, sym.ID, sym.IN, sym.NUMBER, sym.DO, sym.ID, sym.ASM, sym.NUMBER,
				sym.END };
		symbols.put(file, Arrays.asList(symbolsForCase));
