...
abstract class Texp implements AST {
  ...
  abstract public void checkcontext(SymConstraints st);
  
  // set pointers and indices for variables and functions
  abstract public void prepInterp(SymConstraints st);
  
  // interpretation
  abstract public int interpret(int[] in, int[] par, Tprogram prog) throws VariableNotConstrainedException;
}
