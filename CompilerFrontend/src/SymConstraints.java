 ...
 */ 
public class SymConstraints {
  Hashtable<String, SymConstraintEntry> h;        // contains the liste of words
                      // key: String, value: SymtabEntry
  
  SymConstraints pred;  // predecessor symbol table (if exists)

  public SymConstraints() {
    this(null); 
  }

  public SymConstraints(SymConstraints p) {
    h    = new Hashtable<String, SymConstraintEntry>();
    pred = p;
  }

  public boolean enter(String s, SymConstraintEntry e) {
    Object value = lookup(s);
    h.put(s, e);
    return(value==null);
  }

  public SymConstraintEntry lookup(String s) {
    Object value = h.get(s);
    if (value==null && pred!=null)
      value = pred.lookup(s);
    return ((SymConstraintEntry)value);
  }
