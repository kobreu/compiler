...
function solveRecurse (_remainingItemSet, _remainingCapabilities, _reachedGain)
	...
	for count = 0, table.reduce(table.merge(_remainingCapabilities, lEffort, function (a,b) return  math.floor(a/b) end), function (a,b) return a < b and a or b end), 1 do
